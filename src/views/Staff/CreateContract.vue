<template>
    <div class="container mt-5">
        ...
        <InputPaymentDetails title="Down" :payment="downPayment" v-model:isIncluded="downPaymentIncluded" />

        <!-- Last Payment Section -->
        <InputPaymentDetails title="Last" :payment="lastPayment" v-model:isIncluded="lastPaymentIncluded" />
