...
<div class="d-flex">
    ...
    <ul class="nav nav-tabs mb-4">
        ...
        <a
            class="nav-link"
            :class="{ active: activeTab === 'myCustomers' }"
            href="#"
        ...
        <a
            class="nav-link"
            :class="{ active: activeTab === 'allCustomers' }"
            href="#"
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            ...
            <div class="mb-3">
                ...
                <input v-model="newCustomer.first_name" type="text" id="firstName" class="form-control" required />
                <small v-if="backendErrors.first_name" class="text-danger">{{ backendErrors.first_name[0] }}</small>
            </div>

            <div class="mb-3">
                <label for="lastName" class="form-label">Last Name</label>
                <input v-model="newCustomer.last_name" type="text" id="lastName" class="form-control" required />
                <small v-if="backendErrors.last_name" class="text-danger">{{ backendErrors.last_name[0] }}</small>
            </div>

            <div class="mb-3">
                <label for="thirdName" class="form-label">Third Name</label>
                <input v-model="newCustomer.third_name" type="text" id="thirdName" class="form-control" />
                <small v-if="backendErrors.third_name" class="text-danger">{{ backendErrors.third_name[0] }}</small>
            </div>

            <div class="mb-3">
                <label for="phoneNumber" class="form-label">Phone Number</label>
                <input v-model="newCustomer.phone_number" type="tel" id="phoneNumber" class="form-control" required />
                <small v-if="backendErrors.phone_number" class="text-danger">{{ backendErrors.phone_number[0] }}</small>
            </div>

            <div class="mb-3">
                <label for="phoneNumber2" class="form-label">Phone Number 2</label>
                <input v-model="newCustomer.phone_number2" type="tel" id="phoneNumber2" class="form-control" />
                <small v-if="backendErrors.phone_number2" class="text-danger">{{ backendErrors.phone_number2[0] }}</small>
            </div>

            <div class="mb-3">
                <label for="passportSeries" class="form-label">Passport Series</label>
                <input v-model="newCustomer.passport_series" type="text" id="passportSeries" class="form-control" required />
                <small v-if="backendErrors.passport_series" class="text-danger">{{ backendErrors.passport_series[0] }}</small>
            </div>

            <div class="mb-3">
                <label for="passportPlaceIssuance" class="form-label">Passport Place Issuance</label>
                <input v-model="newCustomer.passport_place_issuance" type="text" id="passportPlaceIssuance" class="form-control" required />
                <small v-if="backendErrors.passport_place_issuance" class="text-danger">{{ backendErrors.passport_place_issuance[0] }}</small>
            </div>

            <div class="mb-3">
                <label for="passportDateIssuance" class="form-label">Passport Date Issuance</label>
                <input v-model="newCustomer.passport_date_issuance" type="date" id="passportDateIssuance" class="form-control" required />
                <small v-if="backendErrors.passport_date_issuance" class="text-danger">{{ backendErrors.passport_date_issuance[0] }}</small>
            </div>

            <div class="mb-3">
                <label for="passportJshshr" class="form-label">Passport JSHSHR</label>
                <input v-model="newCustomer.passport_jshshr" type="text" id="passportJshshr" class="form-control" required />
                <small v-if="backendErrors.passport_jshshr" class="text-danger">{{ backendErrors.passport_jshshr[0] }}</small>
            </div>

            <!-- Passport Copy Upload -->
            <div class="mb-3">
                <label for="passportCopy" class="form-label">Passport Copy</label>
                <input @change="handleFileUpload" type="file" id="passportCopy" class="form-control" accept="image/*" />
                <small v-if="backendErrors.passport_copy" class="text-danger">{{ backendErrors.passport_copy[0] }}</small>
            </div>

            <div class="mb-3">
                <label for="password" class="form-label">Password</label>
                <input v-model="newCustomer.password" type="password" id="password" class="form-control" required />
                <small v-if="backendErrors.password" class="text-danger">{{ backendErrors.password[0] }}</small>
            </div>
